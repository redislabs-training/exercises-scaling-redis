...
printf '\nBootstrap: '
docker exec -it security-rbac_redis_enterprise_rbac_1 sh -c "/opt/redislabs/bin/rladmin cluster create name cluster.local username admin@redis.com password redis123"
